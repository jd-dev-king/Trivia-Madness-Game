<<<<<<< HEAD
document.querySelectorAll('.section, .stats, .cta').forEach((element) => {
...
function renderQuestion() {
  ...
  document.getElementById("hudMode").textContent = state.mode === "single" ? "SOLO MODE" : "MULTIPLAYER MODE";
  renderScoreboard();
...
function renderResults() {
  ...
  state.mode === "single" ? "Retry" : "Rematch";
...
loadCategories();
createPlayerFields();
>>>>>>> dcb18f5 (Update responsive hero layout and site styling)
